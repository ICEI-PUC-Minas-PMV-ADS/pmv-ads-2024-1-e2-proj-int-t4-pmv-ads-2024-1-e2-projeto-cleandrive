...
| Passos 	| - Acessar o navegador <br> - Informar o endereço do site http://127.0.0.1/html-csspuc/login.html<br> - Preencher o campo de CPF ou CNPJ <br> - Preencher o campo da senha com no mínimo 6 caracteres <br> - Clicar em "Login" |
